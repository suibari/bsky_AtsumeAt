export const translations = {
  ja: {
    ...
    exchange: {
      ...
      easyExchangeDesc: "シール枚数が一致したランダムな相手と交換します。",
      searchingPartner: "交換相手を探しています...",
      foundPartner: "交換相手が見つかりました！",
      foundPartnerDesc: "{name} さんが見つかりました！交換しますか？",
      easyExchangePending: "交換相手が見つかりませんでした。交換募集リストに登録しました。",
      easyExchangeWait: "10～20秒程度おまちいただく場合があります",
      withdrawTab: "とりさげ",
      withdrawAction: "取り下げる",
      withdrawConfirm: "本当にこの交換募集を取り下げますか？",
      withdrawnTitle: "取り下げ完了",
      withdrawnMessage: "交換募集を取り下げました。",
      noOpenOffers: "現在募集中の交換はありません。",
      easyExchangeLabel: "おきがる交換",
    },
    notifications: {
      title: "通知",
      empty: "新しい通知はありません ✨",
  ...
  en: {
    ...
    exchange: {
      ...
      rejecting: "Rejecting...",
      rejectAction: "Reject",
      easyExchangeTab: "Easy Match",
      easyExchangeDesc: "Exchange with a random partner with matching sticker count.",
      searchingPartner: "Searching for a partner...",
      foundPartner: "Partner found!",
      foundPartnerDesc: "Found {name}! Do you want to exchange?",
      easyExchangePending: "No partner found. Added to exchange waiting list.",
      easyExchangeWait: "It may take about 10-20 seconds",
      withdrawTab: "Withdraw",
      withdrawAction: "Withdraw",
      withdrawConfirm: "Are you sure you want to withdraw this offer?",
      withdrawnTitle: "Offer Withdrawn",
      withdrawnMessage: "Exchange offer has been withdrawn.",
      noOpenOffers: "No open exchange offers found.",
      easyExchangeLabel: "Easy Exchange",
    },
    notifications: {
      title: "Notifications",
